...
$result = $mysqli->query("SELECT inventory.id, inventory.name, category.name as category, price, img_src FROM inventory INNER JOIN category on category.id = inventory.category_id" . $filter);
$allProducts = array();
...
?>
                ...
                <h3 id="cat_title"><?php echo $categoryName; ?></h3><br>
                <div class="container-fluid">
                    ...
                    <div class="product_grid col-md-9">
                        <div class="row">
                        <?php foreach ($allProducts as $item): ?>    <div class="col-md-3">

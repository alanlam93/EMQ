...
<div class="container" id="ctnr">
    ...
    <script type="text/javascript">
            ...
            function makeRouteCallback(routeNum, disp) {
                ...
                return function (response, status) {
                    if (status === google.maps.DirectionsStatus.OK) {
                        ...
                        var t = response.routes[0].overview_polyline;
                        ...
                        for (i = 0; i < legs.length; i++) {
                            ...
                            createMarker(legs[i].end_location, "Customer", legs[i].end_address, "red");
                    ...
                    startAnimation(routeNum, <?php echo $orderDetails['time_elapsed']; ?> * step);
        ...
        function startAnimation(index, startIndex) {
            if (timerHandle[index])
                clearTimeout(timerHandle[index]);
            eol[index] = polyline[index].Distance();
            map.setCenter(polyline[index].getPath().getAt(0));
            poly2[index] = new google.maps.Polyline({path: [polyline[index].getPath().getAt(0)], strokeColor: "#FFFF00", strokeWeight: 3});
            timerHandle[index] = setTimeout("animate(" + index + ", " + startIndex + ")", 2000);  // Allow time for the initial map display
        }

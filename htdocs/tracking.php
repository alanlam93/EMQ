...
?>
                <script type="text/javascript" src="http://maps.google.com/maps/api/js?key=AIzaSyDmNrhRRBuvnxqNgPSluDN-PX59TbDWWBw"></script>
                ...
                <div class="container">
                    ...
                    <script type="text/javascript">
                        ...
                        endLoc[0] = '<?php echo $orderDetails['address'] . ', ' . $orderDetails['city'] . ', ' . $orderDetails['state'] . ' ' . $orderDetails['zip']; ?>';

...
<div class="description">
  <h3>Estimated Delivery Time: </br ><font size="3"><?php echo $warehouseAddress;?> <font color="#33B63B"><b>to</b></font> <?php echo $customerAddress;?></font></h3>
</div>
...
<!--<div id="tools" style="margin-left: 10px;"> <button onclick="setRoutes();">Test</button> </div>-->
